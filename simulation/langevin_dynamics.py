...
from src.numba_target import my_parallel_loop, use_cuda, threadsperblock, my_act_parallel_loop
from simulation.config import Config
from src.utils import KernelBridge, update_langevin_time, kill_kernel, adaptive_step_kernel, swap_kernel
...
class LangevinDynamics(Field):
    ...
    def __init__(self, config):
        ...
        self.alive = np.ones(self.trajs, dtype=bool)
