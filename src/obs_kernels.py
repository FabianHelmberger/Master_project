...
@myjit
def skew_action(idx, phi0, result, sigma, interaction, langevin_time, adims, meas_time):
    """
    ...
    """
    phi_idx = phi0[idx]
    res = sigma * phi_idx*phi_idx + interaction * phi_idx*phi_idx*phi_idx*phi_idx - 1
...
@myjit
def dse_n_moment_kernel(idx, phi0, result, order, sigma, interaction, langevin_time, adims, meas_time):
    """
    ...
    res = order*phi_idx**(order-1)-phi_idx**order * (sigma * phi_idx + interaction * phi_idx*phi_idx*phi_idx)
